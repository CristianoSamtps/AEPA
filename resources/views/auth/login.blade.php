...
<body>
    ...
    <div class="login">
        <section class="container">
            <div class="row row justify-content-center align-items-center"  style="height: 90vh;">
                    ...
                    <div class="col-lg-6">
                        <div class="loginnow">
                            <img class="" src="{{ asset('img/logo_green.svg') }}" alt="AEPABrandLogo"
                                height="50">
    ...
    <section class="container p-5 mt-5 d-flex">
        ...
        <div class="container p-5 newuser">
            <div class="row justify-content-center align-items-center">
                <h1>Ainda não fazes parte?</h1>
                <p>Para obteres mais informações sobre os processos de desenvolvimento dos projetos ou visualizares
                    o teu histórico de doações.</p>

...
<head>
    ...
    <link href="{{ asset('/css/usertemplate.css') }}" rel="stylesheet">
...
<body>
    ...
    <main id="main">
        ...
        <div id="container">
            ...
            <div id="sidebar" data-aos="fade-right" data-aos-anchor="#example-anchor" data-aos-offset="400"
                data-aos-duration="600">
                <ul>

                    <div class="sidebar-background">

                        <svg xmlns="http://www.w3.org/2000/svg" width="197" height="893" viewBox="0 0 197 893"
                            fill="none">
                            <path
                                d="M148.466 768.112C104.426 910.741 -0.998749 891.32 -0.998749 891.32L0.283834 -2.00001L115.811 -1.83414C115.811 -1.83414 159.085 32.1963 177.415 67.109C197.173 104.744 201.898 139.311 188.193 179.587C164.462 249.326 150.802 314.948 164.271 382.445C194.082 531.836 192.506 625.482 148.466 768.112Z"
                                fill="url(#paint0_linear_8_815)" />
                            <defs>
                                <linearGradient id="paint0_linear_8_815" x1="-0.358083" y1="445.096"
                                    x2="571.152" y2="445.916" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#125D35" />
                                    <stop offset="0.244792" stop-color="#019E59" />
                                </linearGradient>
                            </defs>
                        </svg>
                    ...
                    <div class="links">
                        ...
                        <li class="@if (Route::currentRouteName() == 'projetosperfil') active @endif"><a style="text-decoration: none"
                                href="{{ route('projetosperfil', auth()->user()) }}">
                        ...
                        <li class="@if (Route::currentRouteName() == 'donationsperfil') active @endif"><a style="text-decoration: none"
                                href="{{ route('donationsperfil', auth()->user()) }}">
                                <div class="icon-container">
                                    <svg class="icon" xmlns="http://www.w3.org/2000/svg" width="37"
                        ...
                        <li class="@if (Route::currentRouteName() == 'indexperfil') active @endif"><a style="text-decoration: none"
                                href="{{ route('indexperfil', auth()->user()) }}">
                                <div class="icon-container">
                                    <svg class="icon" xmlns="http://www.w3.org/2000/svg" width="34"
                        ...
                        <li class="@if (Route::currentRouteName() == 'editperfil') active @endif"><a style="text-decoration: none"
                    ...
                    <button id="btnsidebar" class="ativar-nav"><i class="fa-solid fa-arrow-right"></i></button>

                    <script>
                        document.addEventListener('DOMContentLoaded', function() {
                            const sidebar = document.getElementById('sidebar');
                            const toggleButton = document.getElementById('btnsidebar');
                            ...
                            btnsidebar.addEventListener('click', function() {
                                ...
                                if (sidebar.classList.contains('open')) {
                                    btnsidebar.innerHTML = '<i class="fa-solid fa-arrow-left"></i>'; // Arrow Left
                                } else {
                                    btnsidebar.innerHTML = '<i class="fa-solid fa-arrow-right"></i>'; // Arrow Right
                                }
                            });
                        });
                    </script>
    ...
    <section class="background2">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1439 621" fill="none">
            ...
            <defs>
                <linearGradient id="paint0_linear_15_69" x1="719.246" y1="0" x2="719.246"
                    y2="620.5" gradientUnits="userSpaceOnUse">

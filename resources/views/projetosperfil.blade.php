                            ...
                            <div id="exprojeto" class="col-12 col-lg-4">
                                <a style="text-decoration: none; display: contents; width: 100%;"
                                    ...
                                    <div class="fundo-projeto">
                                        ...
                                        @else
                                            <img src="{{ asset('public/assets/images/project.jpg') }}"
                                                alt="Imagem do ilustrativaa">
                                        @endif
                                    </div>
                    ...
                    <div id="exprojeto" class="col-12 col-lg-4 eventoCard">
                        <a style="text-decoration: none; display: contents; width: 100%;"
                            ...
                            <div class="deletebutton">
                                <form action="{{ route('cancelarregperfil', ['user' => $user, 'event' => $event->id]) }}"
                                    method="POST" onsubmit="return confirm('Confirma que pretende cancelar inscrição?');">
                                    @csrf
                                    @method('DELETE')

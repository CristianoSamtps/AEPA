    ...
    <div class="row">
      ...
      <div class="col-md-12 d-flex justify-content-center">
        <div class="m-5">
          ...
          <p class="text-center">Fazer a manutenção das florestas e reciclar os materiais recolhidos</p>
        </div>
        <div class="m-5">
          <img class="volillustration" src="{{asset ('img/seguranca.svg')}}" alt="ilustração de limpeza">
          <h3 class="text-center font-weight-bold">Segurança</h3>
          <p class="text-center">Manter as florestas fora de perigo de incêndio</p>
        </div>
        <div class="m-5">
          <img class="volillustration" src="{{asset ('img/plantacao.svg')}}" alt="ilustração de limpeza">
        ...
        <div class="m-5">
          <img class="volillustration" src="{{asset ('img/cuidar.svg')}}" alt="ilustração de limpeza">
...
<section class="container" id="suguesection">
  <div class="container">
    <div class="row">
      <div class="col-md-12 text-center">
        <h1>A comunidade da associação já é uma família</h1>
        <h5>Para chegarmos onde queremos precisamos da tua ajuda, a comunidade é o caminho para o sucesso.
        </h5>
      </div>
      <div class="col-md-12 d-flex justify-content-center hidden2">

...
<div class="container-fluid">
    ...
    <div id="dadosconta" data-aos="fade-left" data-aos-anchor="#example-anchor" data-aos-offset="500" data-aos-duration="500">
        ...
        <form method="POST" action="{{ route('updateperfil', $user) }}" class="form-group" enctype="multipart/form-data">
            ...
            <div id="dados2" class="row">
                ...
                <div class="caixa-detalhes-grande col-lg-12">
                    ...
                    <input disabled type="text" class="input" name="name" id="inputFullname" value="{{ old('name', $user->name) }}" />
                </div>

                <!-- Email -->
                <div class="caixa-detalhes col-lg-3">
                    <label class="txt" for="inputEmail">E-mail</label>
                    <input disabled type="text" class="input" name="email" id="inputEmail" placeholder="exemplo@gmail.com" value="{{ old('email', $user->email) }}" />
                </div>
                ...
                <div class="caixa-detalhes col-lg-3">
                    ...
                    <input disabled type="text" class="input" name="telemovel" id="inputTL" value="{{ old('telemovel', $user->telemovel) }}" />
                </div>

                <!-- Data Nascimento -->
                <div class="caixa-detalhes col-lg-3">
                    <label class="txt" for="inputDN">Data de nascimento</label>
                    <input disabled type="date" class="input" name="data_nascimento" id="inputDN " value="{{ old('data_nascimento', $user->data_nascimento) }}" />
                </div>
...
<div id="pagamentos" data-aos="fade-up" data-aos-anchor="#example-anchor" data-aos-offset="500" data-aos-duration="900">
                    ...
                    <form id="metodoPagamentoForm">
                        ...
                        <div class="form-group">
                            ...
                            <select name="metodo_pag" id="inputMP" class="form-control">
                                ...
                                <option value="CC" {{ old('metodo_pag', $user->metodo_pag) == 'CC' ? 'selected' : '' }}>Cartão de
                                    crédito
                                </option>
                                <option value="TB" {{ old('metodo_pag', $user->metodo_pag) == 'TB' ? 'selected' : '' }}>Transferência
                                    Bancária</option>
                                <option value="RE" {{ old('metodo_pag', $user->metodo_pag) == 'RE' ? 'selected' : '' }}>Referência
                                    Entidade</option>
                ...
                <div id="faq4" class="faq-answer collapse">
                    ...
                    <form method="POST" action="{{ route('updatePassword', $user) }}">
                        ...
                        <div class="caixa-detalhes-grande">
                            <label class="txt" for="inputOldPassword">Password Antiga <span style="color: red">*</span></label>

                            <input required type="password" class="input toggle-password" id="inputOldPassword" name="old_password" value="" />

                            <span toggle="#inputOldPassword" class="fa fa-fw fa-eye field-icon toggle-password"></span>
                        </div>

                        <div class="caixa-detalhes-grande">
                            <label class="txt" for="inputNewPassword">Password Nova <span style="color: red">*</span></label>

                            <input required type="password" class="input toggle-password" id="inputNewPassword" name="new_password" value="" />

                            <span toggle="#inputNewPassword" class="fa fa-fw fa-eye field-icon toggle-password"></span>
                        </div>

                        <div class="caixa-detalhes-grande">
                            <label class="txt" for="inputConfirmPassword">Confirmar Password <span style="color: red">*</span></label>

                            <input required type="password" class="input toggle-password" id="inputConfirmPassword" name="new_password_confirmation" value="" />
                        ...
                        <div class="buttons">
                            ...
                            <a href="{{ route('editperfil', auth()->user()) }}"><button class="cancelar">Cancelar</button></a>
                        </div>

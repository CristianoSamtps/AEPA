  ...
  <section class="container" id="protecaoAmbiental">
    <div class="row">
      ...
      <div class="col-md-6 " id="protecaoAmbientalinfo">
        ...
        <h4>Os projetos da associação estão destinados aos mais necessitados, as maiores tragédias de deflorestação é o ponto mais importante para nós. Temos objetivos definidos para que estes acontecimentos sejam cada vez menos frequentes.
        </h4>
      </div>
    </div>
  </div>
        ...
        <div class="accordion-item">
          ...
          <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
            <div class="accordion-body">
              <p>Os fundos das doações são direcionados para uma variedade de iniciativas ambientais, incluindo projetos de conservação, educação ambiental e sensibilização, programas de reflorestação e a implementação de práticas sustentáveis.
              </div>
            </div>
          </div>
          <div class="accordion-item">
            ...
            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
              <div class="accordion-body">
                <p>Participar nos nossos eventos é simples! Basta estar atento ao nosso calendário de eventos, disponível no nosso site e nas redes sociais. Geralmente, as inscrições são feitas online através de formulários simples que garantem uma fácil participação.
                </div>
              </div>
            </div>
            <div class="accordion-item">
              ...
              <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                  <p>A maioria dos nossos eventos é gratuita para o público, como parte do nosso compromisso em tornar a participação acessível a todos. No entanto, eventos especiais ou programas específicos podem ter uma pequena taxa associada para cobrir custos operacionais. Essas informações detalhadas sobre custos, se aplicáveis, serão sempre claramente comunicadas nas descrições dos eventos e nos materiais de divulgação.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                  <div class="accordion-body">
                  <p>Para aceder ao processo de voluntariado pode dirigir-se a página do projeto ao qual se pretende voluntariar, e ai participar no projeto.
